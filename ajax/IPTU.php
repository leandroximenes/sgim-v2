...
switch ($_GET['acao']) {
    ...
    case 'enviarSMS':
        try {
            ...
            $msg_list = "$telefone; Prezado(a) $nome, nao identificamos junto ao GDF a quitacao do IPTU $iptu. Se foi efetuado o pagamento, favor remeter copia do recibo.Tabakal Imobiliaria; IPTU-{$id}" . "\n";
