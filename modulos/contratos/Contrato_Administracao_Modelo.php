...
<table border='0' width='600' cellpadding='0' cellspacing='0'>
	<tr>
		<td colspan='2'>
			...
			<br/>
			<div class="clJustificar">					
				<b>CLÁUSULA SÉTIMA - </b>O(s)(A) Contratante(s) Locador(es)(a) estipula(m) que tem interesse em receber da Contratada Administradora o aluguel líquido conforme a seguir: Depósito Bancário no <?php echo $banco; ?>  - Agência: <?php echo $agencia . ", "; ?> Conta Corrente <?php echo $conta . ", " . utf8_decode($observacao); ?>.
			</div>			
			<br/>
			<div class="clJustificar">		
