...
//    $linha = $mySQL->fechAssoc($stmt);
    ...
    $valorComissao = ($valorRecebido * $linha['comissao_pagamento']) / 100;
            ...
            <td colspan='2'>
                <div class="clJustificar">
                    ...
                    <table width='600'>
                        <tr>
                            <td>
                                <b>Observações:</b> <?php echo utf8_decode($linha['observacaoRepasse']); ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
