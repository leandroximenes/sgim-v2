...
if(isset($_SESSION["SISTEMA_codPessoa"])){
	...
	function pessoaCadastrar(){
		...
		$nacionalidade      = (isset($_POST['nacionalidade']) ? $_POST['nacionalidade'] : "");
		$dtNascimento     = (!empty($_POST['dataNascimento']) ? new DateTime($_POST['dataNascimento']) : 0);
		$dataNascimento     = (!empty($_POST['dataNascimento']) ? $dtNascimento->format('Y-m-d') : 0);
		...
		$dtNascimentoRepresentante 	= (!empty($_POST['dataNascimentoRepresentante']) ? new DateTime($_POST['dataNascimentoRepresentante'])  : 0);
		$dataNascimentoRepresentante 	= (!empty($_POST['dataNascimentoRepresentante']) ?  $dtNascimentoRepresentante->format('Y-m-d') : 0);
		...
		$dtNascimentoConjuge          = (!empty($_POST['dataNascimentoConjuge']) ? new DateTime($_POST['dataNascimentoConjuge']) : 0);
		$dataNascimentoConjuge          = (!empty($_POST['dataNascimentoConjuge']) ? $dtNascimentoConjuge->format('Y-m-d') : 0);
		...
		if($codTipoPessoa == 1){ //Pessoa Fí­sica
