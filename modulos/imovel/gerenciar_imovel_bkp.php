...
if (isset($_SESSION["SISTEMA_codPessoa"])) {
    ...
    function imovelCadastrar() {
        ...
        $sql = sprintf("call procImovelCadastrar($codImovel, $codProprietario,$codTipoImovel, $codStatusImovel, $codTipoServico, '$endereco', '$bairro', '$cep', '$uf', '$cidade', '$areaPrivativa', '$areaComum', $dce, $valor, $condominio, $quartos, $suites, $banheiros, '$nomeSindico', '$emailSindico', '$telefoneCondominio', '$telefoneSindico', $garagem, '$nIptu','$nCeb', '$nCaesb', '$observacao', '$latitude','$longitude')");
