...
if (isset($_SESSION["SISTEMA_codPessoa"])) {
    ...
    function imovelCadastrar() {
        ...
        $codStatusImovel = $_POST['codStatusImovel'];
        $endereco = $_POST['endereco'];
        $bairro = $_POST['bairro'];
        $cep = str_replace("-", "", $_POST['cep']);
        $nomeSindico = $_POST['nomeSindico'];
        $emailSindico = $_POST['emailSindico'];
        ...
        $codAdministradora = (int) $_POST['codAdministradora'];

        $sql = sprintf("call procImovelCadastrar($codImovel, $codProprietario,$codTipoImovel, $codStatusImovel, $codTipoServico, '$endereco', '$bairro', 
                '$cep', '$uf', '$cidade', '$areaPrivativa', '$areaComum', $dce, $valor, $condominio, $quartos, $suites, $banheiros, '$nomeSindico', 
                '$emailSindico', '$telefoneCondominio', '$telefoneSindico', $garagem, '$nIptu','$nCeb', '$nCaesb', '$observacao', '$latitude','$longitude' , 
                 $codAdministradora, $intermediacao)");
