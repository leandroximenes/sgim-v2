...
if(isset($_SESSION["SISTEMA_codPessoa"])){
	...
	function pagamentoGerenciar(){
		...
		$valorGastoInquilino = str_replace(',','.',$_POST['valorGastoInquilino']);
		...
		$sql = sprintf("call procPagamentoGerenciar($codContrato,$codPagamento,$parcela,'$dataVencimento', $dataPagamento, '$valorPagamento', '$valorDesconto', '$valorMulta','$valorGastoInquilino', '$valorGastoServico', $mesReferencia )");
