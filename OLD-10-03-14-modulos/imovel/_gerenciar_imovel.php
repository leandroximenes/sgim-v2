<?php
	...
	function imovelCadastrar(){
		...
		$sql = sprintf("call procImovelCadastrar($codImovel, $codProprietario,$codTipoImovel, $codTipoServico, '$endereco', '$bairro', '$cep', '$uf', '$cidade', '$areaPrivativa', '$areaComum', $dce, $valor, $condominio, $quartos, $suites, $banheiros, '$telefoneCondominio', '$telefoneSindico', $garagem, '$nIptu','$nCeb', '$nCaesb', '$observacao')");
