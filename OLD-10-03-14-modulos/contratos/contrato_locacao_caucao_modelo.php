	...
	<tr>
		<td colspan='2'>
			...
			<?php
				...
				$strConjugeListar = ' casado(a) com ' . $conjugeLocatarioNome . ', ' . utf8_decode($conjugeLocatarioNacionalidade) . '(a), portador(a) da carteira de identidade ' . $conjugeLocatarioRg . ' ' . $conjugeLocatarioOrgaoExpedidor . ', inscrito(a) no CPF sob o número ' .  $conjugeLocatarioCpf . ',';
				//fim
				
			?>
			<div class="clJustificar">
				<b>C - LOCATÁRIO(S)(A):</b> <?php echo utf8_decode($nomeLocatario); ?>, <?php echo utf8_decode($nacionalidade); ?>(a), <?php echo $profissao; ?>, portador(a) da carteira de identidade <?php echo $rg . ' '. $orgaoExpedidor; ?>, inscrito(a) no CPF sob o <?php echo $cpf; ?>, <?php echo utf8_decode($strConjugeListar); ?> residente(s) e domiciliado(a)(s) na <?php echo utf8_decode($enderecoLocatario); ?> - <?php echo utf8_decode($bairroLocatario) ." - ". utf8_decode($cidadeLocatario) . "-" . $ufLocatario ; ?> – CEP: <?php echo $cepLocatario; ?>.
			</div>
			<br/>
			<div class="clJustificar">
				<b>D – PRAZO: </b> <?php echo $qtdMeses; ?> (<?php echo extenso($qtdMeses, true, false, false); ?>) meses, com início em <?php echo $dataInicio; ?> e término em <?php echo $dataFim; ?>. Ocorrendo prorrogação contratual, tornando-se a avença por prazo indeterminado, responde(m) o(s)(a) LOCATÁRIO(S)(A) nos termos ora pactuados até a efetiva devolução do imóvel.
			</div>
			<br/>
			<div class="clJustificar">
			...
			?>
			A garantia prestada será a caução no valor total <?php echo 'R$ '. number_format($valorx3, 2, ',', '.'); ?> (<?php echo extenso($valorx3, true, true, true); ?>), pago por meio de cheque n° do Banco <?php echo $numeroBanco . " - " .$banco; ?>, agência <?php echo $agencia; ?>, conta corrente <?php echo $conta; ?>, de titularidade de <?php echo $nomeLocatario; ?>, para depósito nesta data na agência 1236-X Conta Corrente 13933-5 em caderneta de poupança da  TABAKAL EMPREENDIMENTOS IMOBILIÁRIOS LTDA., junto ao Banco do Brasil S/A . Os cheques são relativos a 03 (três) alugueres, com o desconto de pontualidade.
			<br/>
			<br/>
			...
			<div class="clJustificar">
				<b>Parágrafo Quarto:</b> O não cumprimento das obrigações expressas neste contrato pelo(s)(a) LOCATÁRIO(S)(A) faculta à LOCADORA a solicitação de inclusão de seu nome no cadastro de devedores do Serviço de Proteção ao Crédito (SPC), ou qualquer outra entidade com finalidade semelhante. O cancelamento da inscrição se dará após a quitação dos débitos existentes, correndo por conta do(a)(s) LOCATÁRIO(A)(S) todas as despesas, bem como a responsabilidade pela baixa do registro.
			</div>

			<br/>

			<div class="clJustificar">
				<b>Parágrafo Quinto:</b> O valor principal da poupança, os juros e a correção monetária auferidos durante a vigência do contrato de locação serão revertidos a favor do(s)(a) LOCATÁRIO(S)(A) no ato da entrega do imóvel, caso o saldo seja suficiente para quitar possíveis débitos junto à LOCADORA.
			</div>

			<br/>

			<div class="clJustificar">
				<b>Parágrafo Sexto:</b>O valor principal da poupança, os juros e a correção monetária poderão ser revertidos ao(s)(a) LOCATÁRIO(S)(A) antecipadamente à resolução definitiva do contrato caso apresente(m) 02 (dois) fiadores idôneos aceitos pela LOCADORA. O presente instrumento será então aditado pelo(s)(a) LOCATÁRIO(S)(A), fiadores e locadora, visando garantir o seu fiel cumprimento.
			</div>
				...
				?>
							...
							?>
									<td align='center' width='50%'>
										...
										<br/>
										CPF: <?php echo $rsConjugeFiadorLinha['nome']; ?>  
									</td>
							<?php
								}
							?>
