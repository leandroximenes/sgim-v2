...
function mascaraCpf($cpf){
    return substr($cpf, 0, 3).'.'.substr($cpf, 3, 6).'.'.substr($cpf, 6, 9).'-'.substr($cpf, 9);
}
...
function mascaraCep($cep){
	...
	$enderecoImovel = utf8_decode($rsLinha['endereco']);
...
<table border='0' width='600' cellpadding='0' cellspacing='0'>
	<tr>
		<td colspan='2'>
			<center><b>PROCURAÇÃO DE ADMINISTRAÇÃO DE IMÓVEL</b></center>
			<br/>
			<br/>
			...
			<div class="clJustificar">
				...
				<?php 
					echo $enderecoLocatario . " - " . $bairroLocatario . " - " . utf8_decode($cidadeLocatario) . " - CEP: " . $cepLocatario; 
				?>
				doravante denominado(s)(a) Contratante(s) Locador(es)(a), nomeia(m) e constitui(em) como procuradora a <b>TABAKAL</b> 
				Empreendimentos Imobiliários Ltda, firma jurídica inscrita CNPJ n° 06.864.021/0001-31 e inscrição CF/DF 07.457.662/001-02 Brasília - DF, telefones (61) 3340-0921/8190-1122, representada pela corretora de imóveis <b>MARLEIDE DE ARAÚJO TELES</b>, CRECI/DF 8091, a qual são outorgados poderes para administrar o imóvel situado no(a)
				<?php echo $enderecoImovel . ', '. $bairroImovel . ', ' . utf8_decode($cidadeImovel) . "-" . $ufImovel . " - CEP: " . $cepImovel; ?>, podendo para tanto, a mandatária praticar, além de todos os atos que se fizerem necessários ao fiel cumprimento deste mandato, nos termos do contrato de Administração de Locação de Imóvel, em anexo, os seguintes: contratar, alterar, prorrogar, assinar termos aditivos contratuais, rescindir locações, 
