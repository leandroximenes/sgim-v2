...
<?php
	...
	if($conjugeLocatarioNome != ""){
		$strConjugeListar = ' casado(a) com ' . utf8_decode($conjugeLocatarioNome) . ', ' . utf8_decode($conjugeLocatarioNacionalidade) . ', portador(a) da carteira de identidade ' . $conjugeLocatarioRg  . ' '  . $conjugeLocatarioOrgaoExpedidor . ', inscrito(a) no CPF sob o número ' .  $conjugeLocatarioCpf . ',';
	}else{
		$strConjugeListar = "";
	}
	//fim
...
<table border='0' width='600' cellpadding='0' cellspacing='0'>
	<tr>
		<td colspan='2'>
			<center><b>Contrato de Administração de Imóvel</b></center>
			<br/>
			<br/>

			<div class="clJustificar">
				<b>Contrato de Administração de Imóvel </b>que fazem entre si, <?php echo utf8_decode($nomeLocatario) . ", " . utf8_decode($nacionalidade) ."(a), ". utf8_decode($profissao) .", " ?> 
			...
			<br />		
			<div class="clJustificar">
				<b>CLÁUSULA PRIMEIRA - </b>O(s)(A) Contratante(s) Locador(es)(a) ajusta(m) com a Contratada Administradora a administração de um imóvel situado na <?php echo $enderecoImovel . ', '. $bairroImovel . ', ' . utf8_decode($cidadeImovel) . "-" . $ufImovel . " - CEP: " . $cepImovel; ?>, tudo de conformidade com os termos da procuração anexa, que passa a fazer parte integrante deste instrumento. 
			</div>
			<br/>
			<div class="clJustificar">
			...
			<br/>
			<div class="clJustificar">
				<b>CLÁUSULA QUINTA - </b>A Contratada Administradora, na hipótese de não pagamento do locatário, efetuará às custas do(s)(a) Contratante(s) Locador(es)(a) os pagamentos dos impostos, taxas, condomínios e outros encargos pertinentes ao imóvel e à sua locação; e as demais despesas decorrentes, bem como as de reparos e pintura que se fizerem necessárias, cobrando-os do locatário e seus fiadores o que for de obrigação destes.
			</div>			
			<br/>
			<div class="clJustificar">
				<b>Parágrafo Único - </b>As despesas com anúncios em jornais, internet, que serão feitos a critério da Contratada Administradora, se houver rescisão de administração antes do imóvel ser locado, correrão por conta do(s)(a) Contratante(s) Locador(es)(a).
			</div>			
			<br/>
			<div class="clJustificar">		
				<b>CLÁUSULA SEXTA - </b>A Contratada Administradora fará jus, a título de remuneração pelos serviços que prestar ao(s)(à) Contratante(s) Locador(es)(a), a comissão de 10% (dez por cento) do valor dos aluguéis líquidos recebidos do locatário, e será esta descontada na prestação mensal de contas, contra recibo.
			</div>			
			<br/>
			<div class="clJustificar">					
				<b>CLÁUSULA SÉTIMA - </b>O(s)(A) Contratante(s) Locador(es)(a) estipula(m) que tem interesse em receber da Contratada Administradora o aluguel líquido conforme a seguir: Depósito Bancário no Banco <?php echo $banco; ?>  - Agência: <?php echo $agencia . ", "; ?> Conta Corrente <?php echo $conta . ", " . utf8_decode($observacao); ?>.
			</div>			
			<br/>
			<div class="clJustificar">		
				<b>CLÁUSULA OITAVA - </b>A Contratada Administradora colocará à disposição do(s)(o) Contratante(s) Locador(es)(a) o valor líquido referente ao aluguel até o quinto dia útil, a contar da data do efetivo recebimento do aluguel. Mensalmente a  Contratada Administradora enviará ao e-mail  <b><?php echo strtolower($emailProprietario); ?></b>, extrato com créditos e débitos relativos à locação.
			</div>			
			<br/>
			<div class="clJustificar">		
				<b>CLÁUSULA NONA - </b>A Contratada Administradora ficará desobrigada de efetuar o pagamento do aluguel ao(s)(à) Contratante(s) Locador(es)(a) se este não for pago pelo locatário em caso de desapropriação, interdição, venda ou penhora, arresto ou seqüestro do imóvel, calamidade pública e guerra, quando ajuizada ação de retomada, ou ainda, quando por qualquer motivo o(s)(a) Contratante(s) Locador(es)(a) der(em) causa a que o locatário retenha o pagamento.
			</div>			
			<br/>
			<div class="clJustificar">		
				<b>CLÁUSULA DÉCIMA - </b>Não efetuado o pagamento do aluguel pelo locatário e necessitando a Contratada Administradora promover a cobrança amigável e/ou judicial contra o mesmo não poderá(ão) o(s)(a) Contratante(s) Locador(es)(a), em hipótese alguma, revogar(em) a procuração que àquela outorgou(aram), nem tampouco obstar(em), por qualquer forma, os procedimentos judiciais que serão promovidos, sob pena de ficar(em) sujeito(s) o(s)(a) Contratante(s) Locador(es)(a) ao pagamento de uma indenização equivalente ao montante do que esteja sendo exigido do locatário em Juízo.
			</div>			
			<br/>
			<div class="clJustificar">					
				<b>CLÁUSULA DÉCIMA PRIMEIRA – </b>Ao(s)(À) Contratante(s) Locador(es)(a) caberão os juros, a correção monetária e as multas cobradas do locatário. Sobre tais verbas serão devidos à Contratada Administradora, o percentual de comissão, na forma pactuada na <b>CLÁUSULA SEXTA</b>.
			</div>			
			<br/>
			<div class="clJustificar">			
				<b>Parágrafo Primeiro - </b> Caso o pagamento do aluguel não seja efetuado pelo locatário na data de vencimento e havendo repasse do valor ao(s)(à) Contratante(s) Locador(es)(a) até o quinto dia útil, a contar da data de seu vencimento, pela Contratada Administradora, a esta caberão o valor principal, os juros, a correção monetária e as multas cobradas do locatário. O pagamento é uma deliberação da Contratada Administradora, não constituindo novação da Contratada Administradora o depósito do valor do aluguel não pago ao(s)(à) Contratante(s) Locador(es)(a).
			</div>
			<br/>

			<div class="clJustificar">			
				<b>Parágrafo Segundo - </b> A Contratada Administradora, mediante consentimento do(s)(a) Contratante(s) Locador(es)(a), promoverá a cobrança ou não da multa de rescisão contratual estipulada no contrato de locação firmado com o locatário, repassando ao(s)(a) Contratante(s) Locador(es)(a) 50% (cinqüenta por cento) do que for cobrado.
			</div>
			
			<br/>
			<div class="clJustificar">							
				<b>CLÁUSULA DÉCIMA SEGUNDA - </b>A Contratada Administradora mediante autorização do(s)(a) Contratante(s) Locador(es)(a) celebrará novo contrato de locação, por prazo idêntico ou diverso, se a locação em curso vier a ser rescindida antes do prazo previsto, seja amigável ou judicialmente.
			</div>			
			<br/>
			<div class="clJustificar">							
				<b>Parágrafo Único - </b>Ocorrendo à hipótese prevista no caput desta Cláusula, se obriga a Contratada Administradora dar ciência ao(s)(à) Contratante(s) Locador(es)(a), tudo com vistas a ser ajustado novo preço e anuência quanto ao novo prazo da locação.
			</div>			
			<br/>
			<div class="clJustificar">							
				<b>CLÁUSULA DÉCIMA TERCEIRA - </b>Ao(s)(À) Contratante(s) Locador(es)(a) será defeso celebrar acordos com locatário sem expressa anuência escrita da Contratada Administradora, assim como ingerir na administração do imóvel, sob pena de multa equivalente ao valor de 01 (um) mês de aluguel conforme disposto na CLÁUSULA TERCEIRA.
			</div>			
			<br/>
			<div class="clJustificar">							
			...
			<br/>
			<div class="clJustificar">							
				a) - Por justa causa, caso a Contratada Administradora, sem qualquer justificativa válida, deixe de prestar contas do aluguel, se recebido do locatário, após o prazo de carência, salvo motivo de força maior, tais como greve bancária, calamidade pública, etc. Nestas circunstâncias nada será devido de comissão à Contratada Administradora, exigindo-se apenas se notifique extrajudicialmente a Contratada Administradora, a fim de que se proceda administrativamente à rescisão do presente contrato, sob pena de não o fazendo ser feita judicialmente. 
			</div>			
			<br/>
			<div class="clJustificar">							
