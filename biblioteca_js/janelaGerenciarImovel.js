function gerenciarImovel() {
    ...
    cbStatusImovel = new Ext.form.ComboBox({
        id: 'cbStatusImovel',
        typeAhead: false,
        fieldLabel: '<b>Status de Imóvel</b>',
        mode: 'local',
        editable: false,
        anchor: '60%',
    ...
    tfIntermediacao = new Ext.form.NumberField({
        fieldLabel: '<b>Intermediação (%)</b>',
        name: 'intermediacao',
        id: 'tfIntermediacao',
        allowBlank: false,
        autoCreate: {tag: 'input', type: 'text', maxlength: '3'},
        blankText: "Por favor insira intermediação.",
        anchor: '40%'
    })
    ...
    tfNomeSindico = new Ext.form.TextField({
        fieldLabel: '<b>Nome Síndico</b>',
        name: 'nomeSindico',
        id: 'tfnomeSidico',
        allowBlank: false,
        blankText: "Por favor insira o nome do sídico.",
        autoCreate: {tag: 'input', type: 'text', maxlength: '45'}, //seta o tamanho máximo q o input vai aceitar
        anchor: '98%'
    });

    tfEmailSindico = new Ext.form.TextField({
        fieldLabel: '<b>Email Síndico</b>',
        name: 'emailSindico',
        id: 'tfemailSidico',
        allowBlank: false,
        blankText: "Por favor insira o email do sídico.",
        autoCreate: {tag: 'input', type: 'text', maxlength: '45'}, //seta o tamanho máximo q o input vai aceitar
        anchor: '98%'
    });
                ...
                callback: function (options, success, response) {
                    try {
                        ...
                        if (retorno.success == true) {
                            ...
                            msg('Informação', 'Não foi possivel cadastrar o imóvel!');
                        }
                    } catch (err) {
