    ...
    var usuarioGrid = new Ext.FormPanel({
        ...
        bbar: [
            ...
            botaoAtualizarVencimento = new Ext.Button({
                ...
                tooltip: '<b>O dia dos próximos vencimentos serão atualizados a partir do mês atual.</b>',
        ...
        Ext.each(gridListaPagamento.getStore().getModifiedRecords(), function(record) {
            Ext.Ajax.request({
                ...
                params: {
                    ...
                    valorGastoInquilino: record.get('valorGastoInquilino'),
