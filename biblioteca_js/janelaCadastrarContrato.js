function cadastrarContrato(codContratoSelecionado) {
    ...
    tfIntermediacao = new Ext.form.NumberField({
        ...
        name: 'intermediacao',
        id: 'tfIntermediacao',
        blankText: "Por favor insira a intermediação.",
        allowBlank: false,
        allowNegative: false,
        anchor: '50%'
    })
...
//            }
    ...
    cbImovel.on('select', function (node, checked, e) {
        Ext.Ajax.request({
            ...
            callback: function (options, success, response) {
                ...
                document.getElementById('tfIntermediacao').value = retorno.resultado[0].intermediacao;
    ...
    function salvar() {
        console.log(codContratoSelecionado);
